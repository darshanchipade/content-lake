                                                ...
                                                <div className="space-y-2 border-t border-slate-100 bg-slate-50 px-3 py-3">
                                                  {group.elements.map((element, elementIndex) => {
                                                    ...
                                                    return (
                                                      ...
                                                      >
                                                        <button
                                                          type="button"  onClick={() => toggleElementDetails(element.id)}
                                                                                                        ...
                                                                                                        >
                                                                                                          ...
                                                                                                          <p className="text-sm font-semibold text-slate-900">
                                                                                                          {primaryLabel}</p>
                                                                                                          {element.newAiAvailable && (<span className="rounded-full bg-amber-50 px-2 py-0.5 text-[11px] font-semibold text-amber-700">New AI available</span>)}</div>
                                                                                                            {sourcePath ? (
                                                                                                          ...
                                                                                                          <div className="space-y-4 border-t border-slate-100 bg-slate-50 px-4 py-4 text-sm text-slate-700">
                                                                                                            ...
                                                                                                            <div className="grid gap-4 lg:grid-cols-3">
                                                                                                                   ...
                                                                                                                   <div className="mt-4">
                                                                                                                     ...
                                                                                                                     <>
                                                                                                                       ...
                                                                                                                       <div className="mt-4">
                                                                                                                         ...
                                                                                                                         {renderChipList(element.classification ?? [], "No classification detected.")}
                                                                                                                       </div>
                                                                                                                     </>
                                                                                                                   )}
                                                                                                                {editState.error && (
                                                                                                              ...
                                                                                                              <div className="rounded-xl border border-slate-100 bg-white p-4">
                                                                                                                <div className="flex flex-wrap items-start justify-between gap-3">
                                                                                                                  ...
                                                                                                                  <div className="flex flex-wrap items-center gap-2">
                                                                                                                    ...
                                                                                                                    {editState.isEditingMetadata && (
                                                                                                                      <button
                                                                                                                        type="button"
                                                                                                                        onClick={() => handleGenerateFields(element, ["keywords", "tags"])}
                                                                                                                        disabled={metadataBusy}
                                                                                                                        className="rounded-full border border-indigo-200 bg-indigo-50 px-3 py-1 text-xs font-semibold text-indigo-700"
                                                                                                                      >
                                                                                                                        {editState.isGeneratingMetadata ? "Generating…" : "Generate all"}
                                                                                                                      </button>
                                                                                                                    )}
                                                                                                                  </div>
                                                                                                                </div>
                                                                                                                ...
                                                                                                                {editState.error && (
                                                                                                                  <p className="mt-3 text-xs text-rose-600">{editState.error}</p>
                                                                                                                )}
                                                                                                              </div>
                                                                                                                                                                        <div className="rounded-xl border border-slate-100 bg-white p-4">
                                                                                                                                                                          <p className="text-xs uppercase tracking-wide text-slate-400">
