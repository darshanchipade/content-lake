      ...
      <div className="flex items-center justify-between gap-2">
        {STEPS.map((step, index) => {
          ...
          return (
            ...
            >
              <div className="flex flex-col items-center gap-2 lg:gap-3 relative">
                <div
                  className={clsx(
                    "flex size-10 lg:size-14 items-center justify-center rounded-full border-2 transition-all duration-200 relative",
                    styles.circle
                  )}
                >
                  <Icon className={clsx("size-5 lg:size-6", styles.iconColor)} />
                  {status === "done" && (
